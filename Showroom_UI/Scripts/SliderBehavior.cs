...
public class SliderBehavior : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    [Space]
    public List<Function> onValueChanged = new List<Function>();
    ...
    private void Start()
    {
        ...
        slider.minValue = minMaxValues.x;
        slider.maxValue = minMaxValues.y;
    ...
    public void OnMouseDown()
    {
        ...
        for(int i = 0; i < onValueChanged.Count; i++)
        {
            ...
            StartCoroutine(Invoke(onValueChanged[i].functionName, onValueChanged[i].functionDelay));
    ...
    public void ResetClick()
    {
        ...
        slider.DOValue(defaultValue, .5f);
