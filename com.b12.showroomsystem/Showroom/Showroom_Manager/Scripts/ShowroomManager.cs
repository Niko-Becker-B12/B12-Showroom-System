...
namespace Showroom
{
    ...
    public class ShowroomManager : MonoBehaviour
    {
        ...
        [FoldoutGroup("General Menu Contents")] [ShowIf("hasPlayButton")] public CustomGeneralMenuButton generalMenuPlayButton;
        [FoldoutGroup("General Menu Contents")] [ShowIf("@this.hasRestartButton || playButtonIsRestartButton")] public CustomGeneralMenuButton generalMenuReplayButton;
        [FoldoutGroup("General Menu Contents")] [ShowIf("playButtonIsPauseButton")] public CustomGeneralMenuButton generalMenuPauseButton;
        [FoldoutGroup("General Menu Contents")] [ShowIf("hasTransparencyButton")] public CustomGeneralMenuButton generalMenuTransparencyToggle;
        [FoldoutGroup("General Menu Contents")] [ShowIf("hasCameraPosButton")] public CustomGeneralMenuButton generalMenuCameraDropdown;
        [FoldoutGroup("General Menu Contents")] [ShowIf("hasDragModeButton")] public CustomGeneralMenuButton generalMenuDragModeButton;
        [FoldoutGroup("General Menu Contents")] [ShowIf("hasResetCameraButton")] public CustomGeneralMenuButton generalMenuBackButton;
        [FoldoutGroup("General Menu Contents")] [ShowIf("hasResetCameraButton")] public CustomGeneralMenuButton generalMenuHomeButton;



        [FoldoutGroup("OLD")] [ShowIf("hasPlayButton")] public List<Function> playButtonFunctions = new List<Function>();
        [FoldoutGroup("OLD")] [ShowIf("@this.hasRestartButton || playButtonIsRestartButton")] public List<Function> resetButtonFunctions = new List<Function>();
        [FoldoutGroup("OLD")] [ShowIf("playButtonIsPauseButton")] public List<Function> pauseButtonFunctions = new List<Function>();
        [FoldoutGroup("OLD")] [ShowIf("hasTransparencyButton")] public List<Function> transparencyButtonFunctions = new List<Function>();
        [FoldoutGroup("OLD")] [ShowIf("hasResetCameraButton")] public List<Function> resetCameraButtonFunctions = new List<Function>();
        [FoldoutGroup("OLD")] [ShowIf("hasDragModeButton")] public List<Function> dragModeButtonFunctions = new List<Function>();
        [FoldoutGroup("OLD")] [ShowIf("hasResetCameraButton")] public List<Function> resetSubLevelCameraButtonFunctions = new List<Function>();
        ...
        public void OnNewCamPos(Transform cameraPos)
        {
            ...
            ShowroomNavigation.Instance.transform.DOMove(pos, 2f).SetEase(Ease.InOutSine);
            ShowroomNavigation.Instance.transform.DORotate(playerRot, 2f).SetEase(Ease.InOutSine).SetOptions(true);
            ShowroomNavigation.Instance.playerCamera.transform.DORotate(-cameraRot, 2f).SetEase(Ease.InOutSine).OnComplete(() => FinishedMovingPlayer(false)).SetOptions(true);

            ShowroomNavigation.Instance.teleportPosition = pos;

            ShowroomNavigation.Instance.playerCamera.DOFieldOfView(cameraPos.GetComponent<Camera>().fieldOfView, 2f);
                ...
                if (timelineSteps.Count > 0 && timelineSteps[0].timeline != null)//(currentTimeline == null && timelineSteps.Count > 0 && timelineSteps[0].timeline != null)
                {
                    ...
                    if (currentTimelineTime == 0)
                    {
                        if (timelineStepperIndex != -1)
                            subLevelUI.spawnedStepperButtons[timelineStepperIndex].OnMouseDown();
                        else
