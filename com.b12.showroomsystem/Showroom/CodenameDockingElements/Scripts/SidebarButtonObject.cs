...
namespace Showroom.UI
{
    ...
    public class SidebarButtonObject : MonoBehaviour
    {
        ...
        public virtual void SetUpButton()
        {
            ...
            this.gameObject.name = "SidebarSubButton_" + sidebarButtonDataContainer.sidebarbuttonUseCaseIndex.ToString() + sidebarButtonDataContainer.sidebarbuttonSiblingIndex.ToString();
        ...
        public virtual void SidebarButtonObjectOnClick()
        {
            ...
            Debug.Log("Usecase Index: " + sidebarButtonDataContainer.sidebarbuttonUseCaseIndex + " | Sibling Index: " + sidebarButtonDataContainer.sidebarbuttonSiblingIndex);

            CodenameDockingElements.Instance.headButtons[sidebarButtonDataContainer.sidebarbuttonUseCaseIndex].sidebarHeadButtonObject.SelectSubButton(sidebarButtonDataContainer.sidebarbuttonSiblingIndex);
