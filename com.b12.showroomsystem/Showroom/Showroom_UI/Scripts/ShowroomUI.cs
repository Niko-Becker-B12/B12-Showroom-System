...
namespace Showroom
{
    ...
    public class ShowroomUI : MonoBehaviour
    {
        ...
        public void CloseTimelineStepper()
        {
            ...
            timelineStepperRect.DOAnchorPos(timelineStepperClosedPos, .5f)
            .OnComplete(() =>
            {

                timelineStepperIsOpen = false;

                ResetTimelineStepper();
        ...
        void ResetTimelineStepper()
        {

            showroomManager.RestartCurrentTimeline();

            timelineStepperSlider.value = 0;

            showroomManager.timelineStepperIndex = -1;
            showroomManager.timelineOldIndex = -1;
            showroomManager.currentTimelineTime = 0;
        ...
        public void ScaleTimelineStepperUp()
        {
            ...
            DOTween.To(() => spacing, x => spacing = x, 216, .5f).OnUpdate(() =>
            {
            ...
            timelineStepperRect.DOSizeDelta(new Vector2(1600f, 156f), .5f);
        ...
        public void ScaleTimelineStepperDown()
        {
            ...
            DOTween.To(() => spacing, x => spacing = x, 74, .5f).OnUpdate(() =>
            {
            ...
            timelineStepperRect.DOSizeDelta(new Vector2(900f, 156f), .5f);
        ...
        {
            if (showroomManager.useCaseIndex == -1)
                if (showroomManager.timelineSteps.Count < 7)
                    return;

            if (showroomManager.useCaseIndex != -1)
                if (showroomManager.useCases[showroomManager.useCaseIndex].timelineSteps.Count < 7)
                    return;
        ...
        public void UpdateStepperUI()
        {
            ...
            foreach(Transform child in timelineStepperParent)
            {
            ...
            if (showroomManager.useCaseIndex == -1)
            {
                ...
                if (showroomManager.hasTimelineStepper)
                {
                    ...
                    //    showroomManager.currentTimeline = showroomManager.timelineSteps[0].timeline;
                    ...
                    for (int i = 0; i < showroomManager.timelineSteps.Count; i++)
                    {
                        ...
                        onClickEventTimelineStepperButton.AddListener(() =>
                        {
                            ...
                            timelineStepperSlider.DOValue(currentTimelineStepperButtonIndex, .25f);
            ...
            else
            {
                ...
                if (showroomManager.useCases[showroomManager.useCaseIndex].hasTimelineStepper)
                {
                    ...
                    //if (showroomManager.currentTimeline == null)
                    //    showroomManager.currentTimeline = showroomManager.useCases[showroomManager.useCaseIndex].timelineSteps[0].timeline;
            ...
            if (showroomManager.useCaseIndex == -1)
            {
                ...
                if (showroomManager.currentTimeline != null)
                {
                    ...
                    if (isRewinding)
                    {
                        ...
                        showroomManager.currentTimeline.Stop(); showroomManager.timelineStepperIndex = newIndex;
                        ...
                        timelineStepperSlider.value = newIndex;
