            ...
            if (!wasClicked)
            {
                ...
                if(isActive)
                {
                    ...
                    for (int i = 0; i < onSetDeactive.Count; i++)
                    {
                        ...
                        StartCoroutine(Invoke(onSetDeactive[i].functionName, onSetDeactive[i].functionDelay));
                ...
                else
                {
                    ...
                    for (int i = 0; i < onSetActive.Count; i++)
                    {
                        ...
                        StartCoroutine(Invoke(onSetActive[i].functionName, onSetActive[i].functionDelay));
