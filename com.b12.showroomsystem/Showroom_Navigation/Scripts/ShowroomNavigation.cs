...
namespace Showroom
{
    ...
    public class ShowroomNavigation : MonoBehaviour
    {
        ...
        [FoldoutGroup("Input Settings/Touch")][SerializeField] private InputActionReference zoomPrimaryTouchPositionInputRef;
        [FoldoutGroup("Input Settings/Touch")][SerializeField] private InputActionReference zoomSecondaryTouchPositionInputRef;
        [FoldoutGroup("Input Settings/Touch")][SerializeField] private InputActionReference zoomSecondaryTouchContactInputRef;
        ...
        void GetInput()
        {
            ...
            zoomSecondaryTouchContactInputRef.action.started += ctx => TouchZoomStart();
            zoomSecondaryTouchContactInputRef.action.canceled += ctx => TouchZoomStop();
        ...
        public void GenerateDefaultEvents()
        {
            ...
            onStartWalkingEvent.AddListener(() =>
            {
                ...
                //ShowroomManager.Instance.showroomUI.generalMenuSubLevelHomeCamButton.gameObject.SetActive(false);
                //ShowroomManager.Instance.showroomUI.generalMenuHomeCamButton.gameObject.SetActive(true);
            ...
            onStartTeleporting.Add(onStartTeleportingEventFunction);
        ...
        public void MoveToFixedPos(Camera camera, bool isAtHome = false)
        {

            DOTween.Kill(this.transform);
            DOTween.Kill(playerCamera);
            ...
            .OnComplete(() => 
            {
                ...
                ShowroomManager.Instance.isAtUseCaseHomePos = isAtHome;
                ableToRotate = true;
                ableToTeleport = true;
        ...
        void TouchZoomStart()
        {
            ...
            touchCoroutine = StartCoroutine(TouchZoomDetection());
        ...
        IEnumerator TouchZoomDetection()
        {
            ...
            while(true)
            {
                ...
                distance = Vector2.Distance(zoomPrimaryTouchPositionInputRef.action.ReadValue<Vector2>(), 
                    zoomSecondaryTouchPositionInputRef.action.ReadValue<Vector2>());
                ...
                else if (distance < previousDistance)   //Zooming In
                {
                    ...
                    distance = Vector3.Distance(desiredPosition, transform.position);
                    Vector3 direction = Vector3.Normalize(desiredPosition - transform.position) * (distance * tempZoomValue);
